...
import org.example.laba_13.Builder.Builder;
import org.example.laba_13.Builder.BuilderFactory;
...
public abstract class AbstractRepository<T> implements Repository<T>{
    ...
    @Override
    public void remove(Integer object) throws RepositoryException {
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(SQLHelper.SQL_REMOVE_USER);
